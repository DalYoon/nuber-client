...
// ====================================================
// GraphQL mutation operation: skipVerification
// ====================================================

export interface skipVerification_SkipPhoneVerification {
  __typename: "SkipPhoneVerificationResponse";
  ok: boolean;
  error: string | null;
}

export interface skipVerification {
  SkipPhoneVerification: skipVerification_SkipPhoneVerification;
}

export interface skipVerificationVariables {
  phoneNumber: string;
}
