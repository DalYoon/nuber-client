...
- watch position and move position of `Marker`
...
- if you want to add `Mutation` with `grapqhl()()` style<br>
  then, you have to define mutation name to call it on props
...
- very important lecture
- difference between `refetching` and `polling`
...
- define `acceptRide` mutation for accepting ride
...
# 3.0 Building for production part One
